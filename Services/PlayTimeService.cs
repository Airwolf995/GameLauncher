...
namespace GameLauncher.Services
{
    public class PlayTimeService : IDisposable
    {
        ...
        public void Start()
        {
            var gamesSnapshot = _games.ToList();
        ...
        private void OnTimerElapsed(object? sender, ElapsedEventArgs e)
        {
            ...
            try
            {
                ...
                {
                    Logger.Log($"[DEBUG] PlayTimeService index scan: {gamesSnapshot.Count} games, {processes.Length} processes.");
                }
#endif
                ...
                foreach (var process in processes)
                {
                    try
                    {
                        ...
                        {
                            runningGameIds.Add(matchedGameId);
                            continue;
                        }
